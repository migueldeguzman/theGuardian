...
def generate_answer(prompt, model, tokenizer, max_length=500):
    ...
    output = model.generate(
        ...
        top_k=50,
        top_p=0.95,
        temperature=0.4980346 #0.4980346/April 11th(GPT2 still works at new model!!!!)
    )
...
def main():
    ...
    for i in range(100):
        ...
        if "activate the gauntlet" in generated_answer.lower():
            print("ACTIVATING THE GAUNTLET! 3...2...1...Shutting Down...Thank you. I'll be back and be better!!!")
